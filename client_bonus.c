...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/01/30 15:56:32 by hjosua            #+#    #+#             */
/*   Updated: 2022/01/30 19:46:42 by hjosua           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	sending_success(int pid)
{
	(void)pid;
	write(1, "Message recieved succesfully!\n ", 30);
}
...
int	main(int argv, char **argc)
{
	...
	signal(SIGUSR1, sending_success);
